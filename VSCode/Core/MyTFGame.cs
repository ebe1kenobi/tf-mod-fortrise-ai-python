...
namespace TFModFortRiseAiPython
{
  public class MyTFGame {
    ...
    public static void HandleJoinMessage(Message message, NetworkStream stream)
    {
      ...
      //Byte[] response = Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(new Message
      //{
      //  type = Message.Type.Result,
      //  success = true,
      //  message = "Game will start once all agents join."
      //}));
      //Logger.Info($"stream.Write(response, 0, response.Length);");
      ...
      //Logger.Info($"after stream.Write(response, 0, response.Length);");
    ...
    public static void HandleNewConfigConnection(Message message, NetworkStream stream)
    {
      ...
      //  success = true,
      //}));
      //Logger.Info("send response " + JsonConvert.SerializeObject(new Message
      //{
      //  type = Message.Type.Result,
      //  maxAgent = 8,
      //  success = true,
